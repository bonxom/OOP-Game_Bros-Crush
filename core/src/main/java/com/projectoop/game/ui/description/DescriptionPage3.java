...
public class DescriptionPage3 extends UICanvas {
    ...
    private void initPage1() {
        ...
        // Background image
        Image backgroundImage = new Image(new Texture("assets/UI/description3_BG.png"));
        ...
        backButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                // Chuyển đến trang cuối cùng nếu đây là trang đầu tiên
                closeDirectly();
                UIManager.getInstance(UIManager.class).openUI(DescriptionPage2.class);
            }
        });
