...
public class BrosStoryCanvas extends UICanvas {

    private Skin skin;

    public BrosStoryCanvas() {
        super();
        initCanvas();
    }
    ...
    private void initCanvas() {
        ...
        // Đặt Background cho Bros
        Image backgroundImage = new Image(new Texture("assets/UI/BrosChoice_BG.png")); // Đường dẫn ảnh bạn đã chuẩn bị
        backgroundImage.setFillParent(true);
        this.addActor(backgroundImage);

        // Nút để tiếp tục hoặc quay lại
